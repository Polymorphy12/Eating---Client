...
export default class SignUp3 extends React.Component {
  ...
  onFill = (text) => {
    if (text.length !== 11) this.setState({empty: true, phoneNum: text});
    else this.setState({empty: false, phoneNum: text});
  }
    ...
    return (
        <SafeAreaView style={styles.fullscreen}>
            ...
            <View style={{flex: 1, marginHorizontal: 16}}>
                ...
                >휴대폰 번호를 입력해주세요.</Text>
                <TextInput
                    style={{fontFamily: 'S-CoreDream-4Regular', fontSize: 16, letterSpacing: -0.23, color: '#6e6e6e', padding: 0, marginTop: 32}}
