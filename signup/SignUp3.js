        ...
        return (
            <SafeAreaView style={styles.fullscreen}>
                    ...
                    <View style={{width: "100%", height: 88, alignItems: "center"}}>
                        ...
                        <View style={{width: "88.2%", flex: 1, flexDirection: "row", justifyContent: "space-between"}}>
                            ...
                            <TouchableOpacity style={{width: 60, height:32, alignItems:"center", borderRadius: 5, backgroundColor: "#ed6578", marginTop: 10}}
                                onPress={() => {
                                    //ToastAndroid.show(this.state._userName, ToastAndroid.SHORT);
                                    //ToastAndroid.show(this.state.optionalCheckBoxChecked ? 'true' : 'false', ToastAndroid.SHORT);
                ...
                <View style={{width: "100%", height: 0, alignItems:"center", flex: 1}}>
                    <TouchableOpacity style={{width: "84.4%", height: 48, alignItems:"center", borderRadius: 50, backgroundColor: (this.state.emailFilled && this.state.pswdFilled && this.state.repswdFilled) ? '#ed6578' : '#fadee2'}}
                        onPress={() => {
