      ...
      render() {        
        return (
            <View style= {{ flex: 1 }}>
                ...
                <ScrollView>
                    <View style = {{marginHorizontal : '3.9%', borderWidth : 1, borderRadius: 4, paddingTop: "3.478%"}}>
                        <View style={{paddingHorizontal: '6.6%'}}>
                            ...
                            <View style={{marginLeft: '12.7%', marginVertical: '3.5%'}}>
                                <View style = {textContainerStyle}>
                                    ...
                                    <Text style={rightTextStyle}>{this.state.price_info.payment_method}</Text>
                                </View>
                                <View style = {textContainerStyle}>
                                    <Text style={leftTextStyle}>주문 금액 : </Text>
                                    <Text style={rightTextStyle}>+ {this.state.price_info.total_price} 원</Text>
                                </View>
                                <View style = {textContainerStyle}>
                                    <Text style={leftTextStyle}>할인 : </Text>
                                    <Text style={rightTextStyle}>- {this.state.price_info.discount} 원</Text>
                                </View>
                                <View style = {textContainerStyle}>
                                    <Text style={leftTextStyle}>결제 금액 : </Text>
                                    <Text style={rightTextStyle}>= {this.state.price_info.total_price - this.state.price_info.discount} 원</Text>
                                </View>
                            </View>
                        </View>
                        <CutLine></CutLine>
                        <View style={{paddingHorizontal: '6.6%'}}>
                            ...
                            <View style={{marginLeft: '12.7%', marginVertical: '3.5%'}}>
                                <View style = {textContainerStyle}>
                                    ...
                                    <Text style={rightTextStyle}>{this.state.deliv_info.order_no}</Text>
                                </View>
                                <View style = {textContainerStyle}>
                                ...
                                <View style = {textContainerStyle}>
                                    ...
                                    <Text style={rightTextStyle}>{this.state.deliv_info.deliv_time}</Text>
                                </View>
                                <View style = {textContainerStyle}>
                                    <Text style={leftTextStyle}>배달장소 : </Text>
                                    <Text style={rightTextStyle}>{this.state.deliv_info.deliv_location}</Text>
                                </View>
                            </View>
                        </View>
                        <View style={{flexDirection: 'row', justifyContent: 'space-evenly', margin: '2.5%'}}>
                            <Image style={{ 
                                ...
                                source={{uri: 'http://13.124.193.165:3000/static/' + this.state.location_image}}
                                > 
                            </Image>
                            <Image style={{ 
                                width: 80, 
                                ...
                                source={{uri: 'http://13.124.193.165:3000/static/' + this.state.location_map}}> 
                            </Image>
                        </View>
                    ...
                    <View style={orderButtonContainer}>
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                ...
                                this.props.navigation.navigate('setPurchase', {userEmail: this.state.userEmail, timeSelect: this.state.timeSelect});
                            }}>
